...
suite('ejs.render(str, dataAndOpts)', function () {
  test('render the template with data/opts passed together', function () {
    assert.equal(ejs.render('<p><?= foo ?></p>', { foo: 'yay', delimiter: '?' }), '<p>yay</p>');
  });
  ...
  test('disallow unsafe opts passed along in data', function () {
    ...
    { _with: false, foo: 'yay', delimiter: '?', localsName: '_' }), '<p>yay</p>');
  });
});
...
suite('<%=', function () {
  ...
  test('should accept custom function', function () {
    ...
    assert.equal(ejs.render('<%= name %>', { name: 'The Jones\'s' }, { escape: customEscape }), 'THE JONES\'S');
  });
});
...
suite('-%>', function () {
  ...
  test('works with unix style', function () {
    ...
    assert.equal(fn({ users: users }), expectedResult);
  });
...
suite('<%_ and _%>', function () {
  test('slurps spaces and tabs', function () {
    assert.equal(ejs.render(fixture('space-and-tab-slurp.ejs'), { users: users }), fixture('space-and-tab-slurp.html'));
  });
});
...
suite('include()', function () {
  ...
  test('include ejs with locals', function () {
    ...
    assert.equal(ejs.render(fixture('include.ejs'), { pets: users }, { filename: file, delimiter: '@' }), fixture('include.html'));
  });

  test('include ejs with absolute path and locals', function () {
    var file = 'test/fixtures/include-abspath.ejs';
    assert.equal(ejs.render(fixture('include-abspath.ejs'), { dir: path.join(__dirname, 'fixtures'), pets: users, path: path }, { filename: file, delimiter: '@' }), fixture('include.html'));
  });
  ...
  test('include ejs with set root path', function () {
    ...
    assert.equal(ejs.render(fixture('include-root.ejs'), { pets: users }, { filename: file, delimiter: '@', root: viewsPath }), fixture('include.html'));
  });
  ...
  test('work with a variable path', function () {
    ...
    assert.equal(ejs.render(fixture('menu.ejs'), { pets: users, varPath: includePath }, { filename: file }), fixture('menu.html'));
  });
...
suite('preprocessor include', function () {
  test('work', function () {
    ...
    assert.equal(ejs.render(fixture('include_preprocessor.ejs'), { pets: users }, { filename: file, delimiter: '@' }), fixture('include_preprocessor.html'));
  });
  ...
  test('whitespace slurp and rmWhitespace work', function () {
    ...
    assert.equal(ejs.render(template, {}, options), expected);
  });
});
...
suite('require', function () {
  ...
  test('allow ejs templates to be required as node modules', function () {
    ...
    if (!process.env.running_under_istanbul) {
      assert.equal(template({ filename: file, pets: users }), fixture('menu_preprocessor.html'));
    }
  });
});
...
//# sourceMappingURL=ejs-compiled-compiled.js.map